        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-zinc-700 bg-zinc-950/70 px-3 py-2.5 pr-10 text-sm text-zinc-100 outline-none ring-0 placeholder:text-zinc-500 focus:border-amber-300/70"
              minLength={8}
              required
            />
            <button
